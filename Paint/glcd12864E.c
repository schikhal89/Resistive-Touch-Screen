...
void main(void)
{
	...
	uint x1,y1,x2,y2,x1new=0,y1new=0,x2new,y2new;
	char buff[32],touchedfirsttime  = 1;
initsyst();
...
_delay_ms(1000);
//GlcdRectangleFill(50,10,50,30,3);
GlcdRectangleFill(30,10,50,30,2);
*/
/*
